...
from cython.parallel cimport prange, parallel, nogil
cimport openmp
#=======================================================================
...
def MC_step(double[:, ::1] arr, float Ts, int nmax):
    ...
    # pragma omp parallel for private(i, j, ix, iy, ang, en0, en1, boltz) \
    #                         shared(arr, xran, yran, aran) \
    #                         reduction(+:accept) schedule(static) collapse(2)
